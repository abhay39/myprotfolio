...
const Footer = () => {
  return (
    <footer>
      <a href='#' className='footer__logo'>Abhay Kumar Gupta</a>
      ...
      <div className="footer__socials">
        ...
        <a href='https://www.instagram.com/abhay_gupta07788/' target='_blank'><BsInstagram/></a>
        <a href='https://github.com/abhay39' target='_blank'><BsGithub/></a>
      </div>
      <div className="footer__copyright">
        <small>&copy;Abhay Kumar Gupta. All right reserved.</small>
      </div>
    </footer>
  )
}
